<?php
namespace HeadPhone\HeadPhoneCollection\Setup\Patch\Data;
...
class HeadPhoneDisplay implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $cmsBlockData = [
            'title' => 'product Headphone Slider Block',
            'identifier' => 'roduct Headphone Slider Block',
            'content' => '{{block class="Magento\Framework\View\Element\Template"
            template="HeadPhone_HeadPhoneCollection::headphone.phtml"}}',
            'is_active' => 1,
            'stores' => [0],
            'sort_order' => 60
        ];
